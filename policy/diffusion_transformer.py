...
from policy.mask_generator import LowdimMaskGenerator
...
class DiffusionTransformerLowdimPolicy(BaseLowdimPolicy):
    ...
    def predict_action(self, obs_dict: Dict[str, torch.Tensor]) -> Dict[str, torch.Tensor]:
        ...
        nobs = self.normalizer.normalize({'obs': obs_dict['obs']})['obs']
        B, _, Do = nobs.shape
        To = self.n_obs_steps
        ...
        if not self.obs_as_cond:
            ...
            obs_pred = self.normalizer.unnormalize({'obs': nobs_pred})['obs']
